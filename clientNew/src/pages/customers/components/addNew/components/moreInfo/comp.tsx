...
type AddNewCustomerMoreInfoSectionProps = {
    moreInfo: string,
...
const AddNewCustomerMoreInfoSection = ({
    moreInfo,
    handleInputChange,
    phoneNumbers,
    setPhoneNumbers
}: AddNewCustomerMoreInfoSectionProps) => {
    const onAddPhone = () => {
...
export default AddNewCustomerMoreInfoSection
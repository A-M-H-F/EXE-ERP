...
const AddNewLocation = () => {
    ...
    const handleNameChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setAddress({ ...address, [name]: capitalizedValue });
    }
    ...
    const handleSaveLocation = async () => {
        ...
        try {
            ...
            const { data } = await apiService.POST('/address', body, token)
            const { message, newCity } = data
            ...
            // update state
            const updatedLocationsList = [...locationsList, newCity]
            dispatch(dispatchGetLocations(updatedLocationsList))
            const updatedActiveLocationsList = [...activeLocationsList, newCity]
                ...
                >
                    <Card
                        ...
                        style={{
                            minHeight: '650px',
                            maxHeight: '650px',
                            minWidth: xs || sm ? '100%' : '20%',
                            marginBottom: xs || sm ? '2em' : '',
                        }}
                    >
                        <div
                            style={{
                    ...
                    >
                        <div
                            style={{
                                minHeight: '500px',
                                maxHeight: '500px',
                                minWidth: xs || sm ? '100%' : '600px',
                                maxWidth: xs || sm ? '100%' : '100%',
                                overflowY: 'auto',
                                overflowX: 'hidden',
                            }}
                        >
